...
const Coin = (props) => {
  ...
  const getPercentChangeColor = (
    ...
    const percent_change_1h_color = percent_change_1h >= 0 ? 'green' : 'red'
    const percent_change_24h_color = percent_change_24h >= 0 ? 'green' : 'red'
    const percent_change_7d_color = percent_change_7d >= 0 ? 'green' : 'red'

    return {
      percent_change_1h_color,
  ...
  const {
    ...
    percent_change_24h_color,
    percent_change_7d_color,
  } = getPercentChangeColor(percent_change_24h, percent_change_7d)
    ...
    <>
      ...
      <div className={style.coinOpenContainer}>
        ...
        <div className={style.coinBtnContainer}>
          ...
          <LinkButton to="/markets" className={style.coinMarketBtn}>
